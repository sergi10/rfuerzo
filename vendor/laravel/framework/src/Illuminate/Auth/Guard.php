...
class Guard implements GuardContract
{
    ...
    /**
     * Devuelve el nivel para el usuario logueado.
     *
     * @return bool
     */
    ...
    /**
     * Devuelve el id  para el usuario logueado.
     *
     * @return bool
     */
    public function get_owner()
    {
        if ($this->guest()) {
            ...
            if ($this->user->level > 0) {
                $profesor = Profesor::where('user', '=', $this->user->name)->get()->first();
                // dd($profesor);
                return $profesor->id;
            }
        }        
    ...
    public function get_alumno_id()
    {
        if ($this->guest()) {
            ...
            if ($this->user->level == 0) {
                $alumno = Alumno::where('user', '=', $this->user->name)->get()->first();
                // dd($profesor);
                return $alumno->id;
            }
        }        
